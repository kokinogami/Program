...
public class HarutoNakayama_Yukino : MonoBehaviour
{
    ...
    Rigidbody rb;
    public static float speed = 50.0f;//加速度
    public static float LimitSpeed = 50.0f;//速度上限
    public static float Jump = 10.0f;//ジャンプ力
    public static float TimeCount;//自動回復インターバル
    private static float mushiCount;
    public static int HP;//?数値
    public static int HPmax;
    public static int GaugeQuantity;
    public static int mushi;//翔蟲の回数制限
    public static int index = 0;//人と雪玉の切り替え
    private static int o_max = 0;

    public static Vector3 Rotate;

    public static Slider GaugeMain;//各ゲージ
    public static Slider Gauge2;
    public static Slider Gauge3;
    public static GameObject UI3;

    public static bool Ground;//地面との接触判定
    public static bool Grider;//グライダー使用中かどうかの判定
    public static bool Count;//回復インターバル管理
    ...
    private static Vector3 bodyHeight = new Vector3(0.0f, -1.000001f, 0.0f);  //氷を生成する位置に関係。体の大きさと氷の厚さに依存
