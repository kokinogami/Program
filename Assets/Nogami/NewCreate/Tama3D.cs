...
public class Tama3D : MonoBehaviour
{
    ...
    private void Update()
    {
        if (boss.StateProcessor.State == boss.StateAttack1 && onsound == false)
        {
            On3Daudio();
            onsound = true;
        }
        else if (boss.StateProcessor.State != boss.StateAttack1 && onsound)
        {
            criAtomSource.Stop();
            onsound = true;
        }
